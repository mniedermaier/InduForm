...
import type { RiskAssessment, AttackPathAnalysis } from '../api/client';
...
export const DEMO_ATTACK_PATHS: AttackPathAnalysis = {
  paths: [
    {
      id: 'ap-001',
      entry_zone_id: 'zone-enterprise',
      entry_zone_name: 'Enterprise Network',
      target_zone_id: 'zone-field',
      target_zone_name: 'Field Device Network',
      target_reason: 'Cell zone with PLC/SCADA/DCS assets',
      steps: [
        {
          conduit_id: 'conduit-ent-dmz',
          from_zone_id: 'zone-enterprise',
          from_zone_name: 'Enterprise Network',
          to_zone_id: 'zone-dmz',
          to_zone_name: 'Industrial DMZ',
          traversal_cost: 48.0,
          weaknesses: [],
        },
        {
          conduit_id: 'conduit-dmz-ctrl',
          from_zone_id: 'zone-dmz',
          from_zone_name: 'Industrial DMZ',
          to_zone_id: 'zone-control',
          to_zone_name: 'Process Control Network',
          traversal_cost: 45.0,
          weaknesses: [],
        },
        {
          conduit_id: 'conduit-ctrl-field',
          from_zone_id: 'zone-control',
          from_zone_name: 'Process Control Network',
          to_zone_id: 'zone-field',
          to_zone_name: 'Field Device Network',
          traversal_cost: 22.0,
          weaknesses: [
            {
              weakness_type: 'unencrypted_protocol',
              description: 'Insecure protocol: Modbus/TCP (no built-in encryption/auth).',
              remediation: 'Migrate Modbus/TCP to a secure alternative (e.g., OPC-UA with TLS) or deploy protocol-aware firewall.',
              severity_contribution: 0.2,
            },
            {
              weakness_type: 'sl_gap',
              description: 'Security level gap of 1 between Process Control Network (SL 3) and Field Device Network (SL 4)',
      ...
      risk_score: 85.2,
      risk_level: 'critical',
      zone_ids: ['zone-enterprise', 'zone-dmz', 'zone-control', 'zone-field'],
      conduit_ids: ['conduit-ent-dmz', 'conduit-dmz-ctrl', 'conduit-ctrl-field'],
    },
    {
      id: 'ap-002',
      entry_zone_id: 'zone-enterprise',
      ...
      target_zone_id: 'zone-field',
      target_zone_name: 'Field Device Network',
      target_reason: 'Contains critical assets (criticality >= 4)',
      steps: [
        {
          conduit_id: 'conduit-ent-dmz',
          from_zone_id: 'zone-enterprise',
        ...
        {
          conduit_id: 'conduit-dmz-site',
          from_zone_id: 'zone-dmz',
          from_zone_name: 'Industrial DMZ',
          to_zone_id: 'zone-site',
          to_zone_name: 'Site Operations',
          traversal_cost: 45.0,
          weaknesses: [],
        },
        {
          conduit_id: 'conduit-site-ctrl',
          from_zone_id: 'zone-site',
          from_zone_name: 'Site Operations',
          to_zone_id: 'zone-control',
          to_zone_name: 'Process Control Network',
          traversal_cost: 45.0,
          weaknesses: [],
          ...
          weaknesses: [
            {
              weakness_type: 'unencrypted_protocol',
              description: 'Insecure protocol: Modbus/TCP (no built-in encryption/auth).',
              remediation: 'Migrate Modbus/TCP to OPC-UA with TLS.',
              severity_contribution: 0.2,
            },
          ],
        },
      ...
      risk_score: 70.8,
      risk_level: 'high',
      zone_ids: ['zone-enterprise', 'zone-dmz', 'zone-site', 'zone-control', 'zone-field'],
      conduit_ids: ['conduit-ent-dmz', 'conduit-dmz-site', 'conduit-site-ctrl', 'conduit-ctrl-field'],
    },
    {
      id: 'ap-003',
      entry_zone_id: 'zone-enterprise',
      entry_zone_name: 'Enterprise Network',
      target_zone_id: 'zone-safety',
      target_zone_name: 'Safety Instrumented Systems',
      target_reason: 'Safety instrumented system',
      steps: [
        {
          conduit_id: 'conduit-ent-dmz',
          from_zone_id: 'zone-enterprise',
        ...
        {
          conduit_id: 'conduit-ctrl-safety',
          from_zone_id: 'zone-control',
          from_zone_name: 'Process Control Network',
          to_zone_id: 'zone-safety',
          to_zone_name: 'Safety Instrumented Systems',
          traversal_cost: 35.0,
          weaknesses: [
            {
              weakness_type: 'no_inspection',
              description: 'No deep packet inspection between zones with SL gap of 1',
      ...
      risk_score: 65.3,
      risk_level: 'high',
      zone_ids: ['zone-enterprise', 'zone-dmz', 'zone-control', 'zone-safety'],
      conduit_ids: ['conduit-ent-dmz', 'conduit-dmz-ctrl', 'conduit-ctrl-safety'],
    },
    {
      id: 'ap-004',
      entry_zone_id: 'zone-enterprise',
      ...
      risk_score: 55.1,
      risk_level: 'medium',
      zone_ids: ['zone-enterprise', 'zone-dmz', 'zone-site', 'zone-control', 'zone-safety'],
      conduit_ids: ['conduit-ent-dmz', 'conduit-dmz-site', 'conduit-site-ctrl', 'conduit-ctrl-safety'],
    },
    {
      id: 'ap-005',
      entry_zone_id: 'zone-enterprise',
      ...
      steps: [
        ...
        {
          conduit_id: 'conduit-field-safety',
          from_zone_id: 'zone-field',
          from_zone_name: 'Field Device Network',
          to_zone_id: 'zone-safety',
          to_zone_name: 'Safety Instrumented Systems',
          traversal_cost: 35.0,
          weaknesses: [
            {
              weakness_type: 'no_inspection',
              description: 'No deep packet inspection between zones at same SL',
              remediation: 'Enable deep packet inspection (IDS/IPS) on this conduit.',
              severity_contribution: 0.15,
            },
          ],
      ...
      risk_score: 45.5,
      risk_level: 'medium',
      zone_ids: ['zone-enterprise', 'zone-dmz', 'zone-control', 'zone-field', 'zone-safety'],
      conduit_ids: ['conduit-ent-dmz', 'conduit-dmz-ctrl', 'conduit-ctrl-field', 'conduit-field-safety'],
    },
  ],
  entry_points: ['Enterprise Network', 'Industrial DMZ'],
  high_value_targets: ['Safety Instrumented Systems', 'Field Device Network', 'Process Control Network'],
  summary: '5 attack path(s) identified, 1 critical, 2 high, 2 medium.',
  counts: { total: 5, critical: 1, high: 2, medium: 2, low: 0, minimal: 0 },
};
