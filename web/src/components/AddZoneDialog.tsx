        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto dark:text-gray-200">
              ...
              <div className="grid grid-cols-2 gap-2">
                {ZONE_TEMPLATES.map(template => (
                  <button
                    ...
                    className="text-left px-3 py-2 rounded-sm border border-gray-200 dark:border-gray-600 hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors"
                  >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-hidden focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200"
            />
          </div>
              ...
              {Object.entries(ZONE_TYPE_CONFIG)
                ...
                .map(([key, config]) => (
                  <label
                    key={key}
                    className={`
                      flex items-center gap-2 px-2 py-1.5 rounded-sm border cursor-pointer transition-all
                      ${type === key
